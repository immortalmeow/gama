package com.android.fitmoveai.ui.camera.situp
...
import com.android.fitmoveai.ui.camera.RearCameraSource
import com.android.fitmoveai.ui.camera.dumbell.RearDumbelCameraActivity
...
import com.android.fitmoveai.ui.workout.situp.SitupCounter
...
class RearCameraSitupActivity:AppCompatActivity() {

    private var cameraSource: RearCameraSource? = null
    ...
    private val workoutName:String="Sit Up"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSwitch.setOnClickListener {
            ...
            startActivity(Intent(this, CameraSitupActivity::class.java))
            finish()
        }
    ...
    private fun resetTimer() {
        CameraPushupActivity.workoutCounter.reset()
        elapsedTime = 0
    ...
    private fun openCamera() {
        if (isCameraPermissionGranted()) {
            if (cameraSource == null) {
                cameraSource = RearCameraSource(surfaceView, object : RearCameraSource.CameraSourceListener {
    ...
    companion object {
        ...
        fun setWorkoutCounter(workout : String)
        {
            ...
            else if (workout == "Dumbell"){
                workoutCounter = DumbbellCounter()
            }
        }
        var workoutCounter : WorkoutCounter = SitupCounter()
    }
