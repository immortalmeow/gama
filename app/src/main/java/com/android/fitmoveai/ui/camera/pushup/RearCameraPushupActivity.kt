package com.android.fitmoveai.ui.camera.pushup
...
class RearCameraPushupActivity:AppCompatActivity() {
    ...
    private val workoutName:String = "Pushup"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSwitch.setOnClickListener {
            ...
            startActivity(Intent(this, RearCameraPushupActivity::class.java))
            finish()
        }
