package com.android.fitmoveai.ui.camera.dumbell
...
class RearDumbelCameraActivity:AppCompatActivity() {
    ...
    private val workoutName:String="Dumbell"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSwitch.setOnClickListener {
            ...
            startActivity(Intent(this, RearDumbelCameraActivity::class.java))
            finish()
        }
    ...
    companion object {
        ...
        var workoutCounter : WorkoutCounter = DumbbellCounter()
    }
